...
| `packages/skills` | Consumer-facing AI material — mode-gated per-SDK-package skills (each with integration + migration knowledge subtrees) plus a cross-cutting `sodax-build` front-door / ideation skill | [`packages/skills/CLAUDE.md`](packages/skills/CLAUDE.md) |
