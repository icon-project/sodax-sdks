...
Consumer-facing AI material (skills + knowledge for coding agents, Cursor, Codex) lives in [`packages/skills`](../skills/AGENTS.md) — not in this package.
