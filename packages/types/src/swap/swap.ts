...
export const swapSupportedTokens = {
  ...
  [ChainKeys.STELLAR_MAINNET]: [
    ...
    spokeChainConfig[ChainKeys.STELLAR_MAINNET].supportedTokens.GOOGL,
    spokeChainConfig[ChainKeys.STELLAR_MAINNET].supportedTokens.AMZN,
    spokeChainConfig[ChainKeys.STELLAR_MAINNET].supportedTokens.MSFT,
    spokeChainConfig[ChainKeys.STELLAR_MAINNET].supportedTokens.META,
    spokeChainConfig[ChainKeys.STELLAR_MAINNET].supportedTokens.CRCL,
    spokeChainConfig[ChainKeys.STELLAR_MAINNET].supportedTokens.COIN,
    spokeChainConfig[ChainKeys.STELLAR_MAINNET].supportedTokens.PLTR,
    spokeChainConfig[ChainKeys.STELLAR_MAINNET].supportedTokens.TSM,
  ...
  [ChainKeys.HEDERA_MAINNET]: [
    ...
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.GOOGL,
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.AMZN,
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.MSFT,
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.META,
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.CRCL,
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.COIN,
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.PLTR,
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.TSM,
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.AMD,
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.INTC,
    spokeChainConfig[ChainKeys.HEDERA_MAINNET].supportedTokens.BABA,
  ] as const satisfies XToken[],
