...
export const robinhoodSupportedTokens = {
  ...
  // Robinhood Token" product. No dedicated Sonic vault exists for any of
  // these yet, so `vault` mirrors `hubAsset` (same convention as the Solana
  // xStock entries above).
  SPCX: {
    symbol: 'SPCX',
    name: 'SpaceX Class A',
    decimals: 18,
    ...
    vault: '0x2676b346bea3a760fe5386014e51760b511f65fb',
  },
  NVDA: {
    symbol: 'NVDA',
    name: 'NVIDIA',
    ...
    vault: '0xa754bf15f0289b539aae5ce1a453e28898b7704e',
  },
  GME: {
    symbol: 'GME',
    name: 'GameStop',
    ...
    vault: '0x9f9a7d7283a897b2d4b16eb6dd07faa40fead168',
  },
  DJT: {
    symbol: 'DJT',
    name: 'Trump Media',
    ...
    chainKey: ChainKeys.ROBINHOOD_MAINNET,
    hubAsset: '0x2027aa4839be98f9021c1608754cd793833e24ea',
    vault: '0x2027aa4839be98f9021c1608754cd793833e24ea',
  },
  RDDT: {
    symbol: 'RDDT',
    name: 'Reddit',
    ...
    chainKey: ChainKeys.ROBINHOOD_MAINNET,
    hubAsset: '0xec85b1ac463f8987c72d13dd3df4e4dc2f263dcf',
    vault: '0xec85b1ac463f8987c72d13dd3df4e4dc2f263dcf',
  },
  MSTR: {
    symbol: 'MSTR',
    name: 'Strategy',
    ...
    vault: '0x3dea14c781e6750e8524c47cb2a9becc1c63d599',
  },
  AAPL: {
    symbol: 'AAPL',
    name: 'Apple',
    ...
    vault: '0xf66a3327066c97c00915d5017262fb37d000a5df',
  },
  TSLA: {
    symbol: 'TSLA',
    name: 'Tesla',
    ...
    vault: '0x22bd6dc64fca01887818b5c701bf3f8cc5679461',
  },
  MU: {
    symbol: 'MU',
    name: 'Micron',
    ...
    vault: '0xab01212d77d27b1098bf64b812300f81e1448f37',
  },
  SNDK: {
    symbol: 'SNDK',
    name: 'SanDisk',
    ...
    vault: '0xc30bf06eafff781cddb65b3bd337a214be9ff7f7',
  },
  SPY: {
    symbol: 'SPY',
    ...
    vault: '0x6ec91122458067b436c84bd8c0be5d8cd5f222e8',
  },
  QQQ: {
    symbol: 'QQQ',
    ...
    vault: '0xb3b0b8ae18c34545d8e0234d3e4ba86db46eca5b',
  },
  SGOV: {
    symbol: 'SGOV',
    ...
    vault: '0x8f33dbcbdc6572adb8b030508a02b599380f3cc7',
  },
  USO: {
    symbol: 'USO',
    ...
    vault: '0x9c188579ba2ed2e8ea15e5f53392820add3af9ce',
  },
  GLD: {
    symbol: 'GLD',
    ...
    chainKey: ChainKeys.ROBINHOOD_MAINNET,
    hubAsset: '0xe72fa58dc1ab501d530fbc98de2973f9cfaf37bc',
    vault: '0xe72fa58dc1ab501d530fbc98de2973f9cfaf37bc',
  },
  SLV: {
    symbol: 'SLV',
    ...
    vault: '0x17348849806c8b1b5d1d3abbcb527d05d21d09d5',
  },
} as const satisfies Record<string, XToken>;
