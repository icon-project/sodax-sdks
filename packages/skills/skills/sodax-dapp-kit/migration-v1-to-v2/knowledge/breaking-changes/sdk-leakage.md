...
Full SDK-level detail: `sodax-sdk`: `migration-v1-to-v2/knowledge/breaking-changes/type-system.md`.
...
Full SDK-level detail: `sodax-sdk`: `migration-v1-to-v2/knowledge/features/` — each feature's migration file lists the required new fields.
...
**Config is tracked by reference in v2.** See [`recipes/setup.md#config-reactivity`](../../../integration/knowledge/recipes/setup.md#config-reactivity) for the module-const vs `useMemo` patterns. Drive runtime config switches (e.g. solver env) through `useMemo` deps, not by remounting the provider.
...
Full SDK-level detail: `sodax-sdk`: `migration-v1-to-v2/knowledge/breaking-changes/architecture.md` (Appendix B).
...
For the full SDK migration playbook, start at `sodax-sdk`: `migration-v1-to-v2/knowledge/README.md`.

## Cross-references

- `sodax-sdk`: `migration-v1-to-v2/knowledge/README.md` — full SDK migration overview.
- `sodax-sdk`: `migration-v1-to-v2/knowledge/breaking-changes/type-system.md` — type renames + ChainKeys.
- `sodax-sdk`: `migration-v1-to-v2/knowledge/breaking-changes/architecture.md` — `*SpokeProvider`, ConfigService, SodaxConfig reshape.
- `sodax-sdk`: `migration-v1-to-v2/knowledge/breaking-changes/result-and-errors.md` — `Result<T>` + error class consolidation.
