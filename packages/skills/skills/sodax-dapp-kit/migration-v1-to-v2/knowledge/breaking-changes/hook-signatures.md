...
See [`recipes/invalidations.md`](../../../integration/knowledge/recipes/invalidations.md) for the full pattern.
...
- [`architecture.md`](../../../integration/knowledge/architecture.md) — the canonical v2 hook shapes.
