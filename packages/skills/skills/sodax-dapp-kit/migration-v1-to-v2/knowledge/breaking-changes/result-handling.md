...
- [`recipes/mutation-error-handling.md`](../../../integration/knowledge/recipes/mutation-error-handling.md) — full v2 patterns for picking call shapes.
- [`architecture.md`](../../../integration/knowledge/architecture.md) § "SDK Result handling" — full design rationale.
- `sodax-sdk`: `migration-v1-to-v2/knowledge/breaking-changes/result-and-errors.md` — SDK-side `Result<T>` migration (the underlying contract that dapp-kit translates).
