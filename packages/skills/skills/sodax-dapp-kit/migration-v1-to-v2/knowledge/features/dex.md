...
Pair: [`features/dex.md`](../../../integration/knowledge/features/dex.md).
...
- [`features/dex.md`](../../../integration/knowledge/features/dex.md) — v2 reference.
- [`recipes/dex.md`](../../../integration/knowledge/recipes/dex.md) — full v2 worked example.
- `sodax-sdk`: `migration-v1-to-v2/knowledge/features/dex.md` — underlying SDK DEX migration.
