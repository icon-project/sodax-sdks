...
- [`features/staking.md`](../../../integration/knowledge/features/staking.md) — v2 reference.
- [`recipes/staking.md`](../../../integration/knowledge/recipes/staking.md) — full v2 worked example.
- `sodax-sdk`: `migration-v1-to-v2/knowledge/features/staking.md` — underlying SDK staking migration.
