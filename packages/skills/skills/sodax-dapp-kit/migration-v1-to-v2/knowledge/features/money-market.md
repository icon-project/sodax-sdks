...
- [`features/money-market.md`](../../../integration/knowledge/features/money-market.md) — v2 reference.
- [`recipes/money-market.md`](../../../integration/knowledge/recipes/money-market.md) — full v2 worked example.
- [`../breaking-changes/sdk-leakage.md`](../breaking-changes/sdk-leakage.md) — `srcChainKey`/`srcAddress` required.
- `sodax-sdk`: `migration-v1-to-v2/knowledge/features/money-market.md` — underlying SDK MM migration.
