...
Every file in this directory has a sibling in [`features/`](../../../integration/knowledge/features/) with the same filename — the v2 design context for that feature. When you're stuck in one, the other is one path-swap away.
