...
Pair: [`features/bridge.md`](../../../integration/knowledge/features/bridge.md).
...
- [`features/bridge.md`](../../../integration/knowledge/features/bridge.md) — v2 reference.
- [`recipes/bridge.md`](../../../integration/knowledge/recipes/bridge.md) — full v2 worked example.
- `sodax-sdk`: `migration-v1-to-v2/knowledge/features/bridge.md` — underlying SDK bridge migration.
