...
- [`features/bitcoin.md`](../../../integration/knowledge/features/bitcoin.md) — v2 reference.
- [`recipes/bitcoin.md`](../../../integration/knowledge/recipes/bitcoin.md) — full v2 worked examples.
