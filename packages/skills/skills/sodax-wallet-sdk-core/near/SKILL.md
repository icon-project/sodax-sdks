...
Sibling chain skills follow the same shape — evm, solana, sui, bitcoin, stellar, icon, injective, stacks, aleo. For multi-chain or undecided work, load the broad [`sodax-wallet-sdk-core` skill](../SKILL.md).
