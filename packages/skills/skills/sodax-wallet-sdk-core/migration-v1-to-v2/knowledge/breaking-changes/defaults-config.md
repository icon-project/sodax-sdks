...
Shallow only. Nested objects are **replaced wholesale**, not deep-merged. See [`recipes/defaults-and-overrides.md`](../../../integration/knowledge/recipes/defaults-and-overrides.md).
