...
`@sodax/wallet-sdk-react` handles the construction internally — see `sodax-wallet-sdk-react`: `integration/knowledge/recipes/setup.md`. Skip this recipe (the manual path) unless you are:
