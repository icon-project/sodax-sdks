...
2. **`RecoveryService`:** **new in v2.** No v1 equivalent — there's no migration to do for code that didn't exist before. Just integration: see [`features/auxiliary-services.md`](../../../integration/knowledge/features/auxiliary-services.md).
...
See [`features/auxiliary-services.md`](../../../integration/knowledge/features/auxiliary-services.md) § "RecoveryService".
...
- v2 auxiliary services usage: [`features/auxiliary-services.md`](../../../integration/knowledge/features/auxiliary-services.md).
