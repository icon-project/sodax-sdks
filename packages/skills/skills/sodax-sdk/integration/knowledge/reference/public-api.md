...
import {
  // Main entry
  Sodax,
  type SodaxOptions, // constructor param: DeepPartial<SodaxDefaultConfig> & client options (logger + global fee + global apiKey)
  ...
  type SwapsApiConfig,          // BaseApiConfig & { apiKey? } — apiKey becomes x-api-key on /swaps/*
