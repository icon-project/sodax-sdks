...
- Stellar destinations require an activated account and a trustline first: [`../chain-specifics.md`](../chain-specifics.md) § "Stellar account activation and trustline".
