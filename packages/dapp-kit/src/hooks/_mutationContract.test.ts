...
const HOOKS: Array<{ path: string; nativeThrow?: true }> = [
  ...
  { path: 'externalWallets/useUpgradeToSmartAccount.ts', nativeThrow: true },
  { path: 'gasless/useGaslessPrepare.ts' },
  { path: 'gasless/useGaslessSubmit.ts' },
  { path: 'gasless/useGaslessSendCalls.ts' },
  { path: 'gasless/useGaslessRelay.ts' },
