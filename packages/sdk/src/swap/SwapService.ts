...
export type SwapServiceConstructorParams = {
  ...
  /** Opt-in backend submit-tx 2-step flow (from `SodaxOptions.swaps.useBackendSubmitTx`). Default off. */
...
export class SwapService {
   ...
   * - **Backend 2-step (opt-in via `swaps.useBackendSubmitTx`), {@link submitTx}:** hands the
  ...
  /**
   * Backend 2-step swap path (opt-in via `swaps.useBackendSubmitTx`): hand the broadcast
