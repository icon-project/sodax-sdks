...
export class ConfigService {
  ...
  // Dynamic config-v2 fetch is gated off until the flattened `/config/all` endpoint mapping is wired
  // (see the commented body in `initialize()`); re-enable these fields together with it.
