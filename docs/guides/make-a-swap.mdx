---
title: "Make a Swap"
description: "Step-by-step walkthrough for executing a cross-chain swap with the Sodax SDK, from initialization to error handling."
---
...
<Step title="Initialize Sodax Instance">
...
See [Configure SDK](/guides/configure-sdk) for the full `SodaxConfig` shape and canonical override patterns.

</Step>

<Step title="Obtain a Wallet Provider">
...
<Step title="Get a Quote (Optional but Recommended)">
...
<Step title="Check Token Allowance">
...
<Step title="Prepare Intent Parameters">
...
<Step title="Check Intent Status">
