...
description: "Integrate Bitcoin as a source or destination network with the Sodax SDK using the per-user trading-wallet flow."
---
...
<Step title="Enable Bitcoin in your wallet provider">
...
<Step title="Connect a Bitcoin wallet">
...
<Step title="Sign in and provision the trading wallet">
...
<Step title="Fund the trading wallet">
...
<Step title="Build the readiness gate">
...
<Step title="Build CreateIntentParams with Bitcoin-specific overrides">
