...
Outside React, construct the provider from `@sodax/wallet-sdk-core` directly:
...
- All nine chain families' providers: [Setup Wallet Providers](/developers/packages/sdk/docs/WALLET_PROVIDERS)
