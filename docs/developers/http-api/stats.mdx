...
- The figure is **fractional**, so it is not `BigInt`-parseable: `BigInt("1499655823.120187263279086593")` throws a `SyntaxError`, and `Number()` silently truncates it to `1499655823.1201873`. Keep it as a string for display, or parse it with a decimal library.
