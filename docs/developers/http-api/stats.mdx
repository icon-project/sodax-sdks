...
Returns fee and volume rollups for a fee-receiver address (useful for partner dashboards). Pair with the [Monetize SDK](/developers/packages/sdk/docs/MONETIZE_SDK) for on-chain fee claim flows.
