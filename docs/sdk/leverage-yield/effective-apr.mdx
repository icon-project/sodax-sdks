---
title: "Effective APR"
description: "How the SDK computes the headline effective APR for a leverage-yield vault by combining on-chain AAVE rates with the underlying LSD's native staking yield."
---
