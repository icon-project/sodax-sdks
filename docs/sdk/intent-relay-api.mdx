...
description: "Cross-chain intent relay service for submitting transactions and retrieving relay packets across chains, including the relayTxAndWaitPacket entry point."
---
