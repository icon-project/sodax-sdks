---
title: "Backend API"
description: "HTTP client (BackendApiService) for the SODAX backend API covering intent lookup, solver orderbook, money market data, and runtime configuration."
---
