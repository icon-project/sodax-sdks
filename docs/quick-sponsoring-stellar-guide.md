...
**Examples**
- [apps/demo/src/providers.tsx:49-54](https://github.com/icon-project/sodax-sdks/blob/main/apps/demo/src/providers.tsx#L49-L54) — sponsoring API URL + key setup: reads `VITE_SPONSORING_API_BASE_URL` / `VITE_SPONSORING_API_KEY`, omits each when unset (falls back to the packaged endpoint), passed as `api.sponsoringApiConfig` on the `Sodax` config at [L138](https://github.com/icon-project/sodax-sdks/blob/main/apps/demo/src/providers.tsx#L138). Env placeholders in [apps/demo/example.env](https://github.com/icon-project/sodax-sdks/blob/main/apps/demo/example.env).
