...
| `apps/playground` | Public SDK playground: a live dapp-kit swap beside the code that produced it; embedded in the docs and on sodax.com | [`apps/playground/AGENTS.md`](apps/playground/AGENTS.md) |
