    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Transfer BTC from your wallet to your Bound Exchange trading wallet</DialogDescription>
        </DialogHeader>
        ...
        <div className="flex items-center justify-center gap-6 py-4">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-xs text-muted-foreground">{formatUnits(walletBalance, 8)} BTC</span>
          </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex items-center gap-2 bg-muted rounded-lg px-3 py-2.5 border border-border">
            <span className="text-sm font-mono text-muted-foreground break-all flex-1">{tradingAddress}</span>
            <button
              type="button"
              onClick={copyAddress}
        ...
        <div className="flex items-start gap-2 pt-1 text-xs text-muted-foreground">
          ...
          <span>
            Your trading wallet is a 2-of-2 multisig with Bound Exchange. You retain full custody — Bound Exchange's
            co-sign expires after 3 months.
          </span>
        </div>
      </DialogContent>
    </Dialog>
