...
const radfiConfig: RadfiConfig = {
  url: IS_TESTNET ? 'https://signet.api.bound.exchange/api' : 'https://staging.api.bound.exchange/api',
  apiKey: 'YOUR_API_KEY',
  umsUrl: IS_TESTNET ? 'https://signet.api.ums.bound.exchange/api' : 'https://staging.api.ums.bound.exchange/api',
}
